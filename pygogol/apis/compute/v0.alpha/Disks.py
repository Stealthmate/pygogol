...
def addResourcePolicies(disk=None, project=None, zone=None, requestId=None):
    url = baseUrl + "{project}/zones/{zone}/disks/{disk}/addResourcePolicies"
    method = "POST"
    return Request(
        method, 
...
def getIamPolicy(project=None, resource=None, zone=None):
    url = baseUrl + "{project}/zones/{zone}/disks/{resource}/getIamPolicy"
    method = "GET"
    return Request(
        method, 
...
def removeResourcePolicies(disk=None, project=None, zone=None, requestId=None):
    url = baseUrl + "{project}/zones/{zone}/disks/{disk}/removeResourcePolicies"
    method = "POST"
    return Request(
        method, 
        url.format(['disk', 'project', 'zone']) + "?" + "&".join(),
...
def setIamPolicy(project=None, resource=None, zone=None):
    url = baseUrl + "{project}/zones/{zone}/disks/{resource}/setIamPolicy"
    method = "POST"
    return Request(
        method, 
        url.format(['project', 'resource', 'zone']) + "?" + "&".join(),
