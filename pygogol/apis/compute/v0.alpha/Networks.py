...
def listIpOwners(network=None, project=None, filter=None, ipCidrRange=None, maxResults=None, orderBy=None, ownerProjects=None, ownerTypes=None, pageToken=None, subnetName=None, subnetRegion=None):
    url = baseUrl + "{project}/global/networks/{network}/listIpOwners"
    method = "GET"
    return Request(
        method, 
        url.format(['network', 'project']) + "?" + "&".join(),
