...
def getIamPolicy(project=None, resource=None):
    url = baseUrl + "{project}/global/backendBuckets/{resource}/getIamPolicy"
    method = "GET"
    return Request(
        method, 
...
def setIamPolicy(project=None, resource=None):
    url = baseUrl + "{project}/global/backendBuckets/{resource}/setIamPolicy"
    method = "POST"
    return Request(
        method, 
        url.format(['project', 'resource']) + "?" + "&".join(),
...
def testIamPermissions(project=None, resource=None):
    url = baseUrl + "{project}/global/backendBuckets/{resource}/testIamPermissions"
    method = "POST"
    return Request(
        method, 
        url.format(['project', 'resource']) + "?" + "&".join(),
