...
def addResourcePolicies(instance=None, project=None, zone=None, requestId=None):
    url = baseUrl + "{project}/zones/{zone}/instances/{instance}/addResourcePolicies"
    method = "POST"
    return Request(
        method, 
        url.format(['instance', 'project', 'zone']) + "?" + "&".join(),
...
def getGuestAttributes(instance=None, project=None, zone=None, variableKey=None):
    url = baseUrl + "{project}/zones/{zone}/instances/{instance}/getGuestAttributes"
    method = "GET"
    return Request(
        method, 
        url.format(['instance', 'project', 'zone']) + "?" + "&".join(),
...
def getIamPolicy(project=None, resource=None, zone=None):
    url = baseUrl + "{project}/zones/{zone}/instances/{resource}/getIamPolicy"
    method = "GET"
    return Request(
        method, 
...
def removeResourcePolicies(instance=None, project=None, zone=None, requestId=None):
    url = baseUrl + "{project}/zones/{zone}/instances/{instance}/removeResourcePolicies"
    method = "POST"
    return Request(
        method, 
        url.format(['instance', 'project', 'zone']) + "?" + "&".join(),
...
def resume(instance=None, project=None, zone=None, requestId=None):
    url = baseUrl + "{project}/zones/{zone}/instances/{instance}/resume"
    method = "POST"
    return Request(
        method, 
        url.format(['instance', 'project', 'zone']) + "?" + "&".join(),
...
def setIamPolicy(project=None, resource=None, zone=None):
    url = baseUrl + "{project}/zones/{zone}/instances/{resource}/setIamPolicy"
    method = "POST"
    return Request(
        method, 
        url.format(['project', 'resource', 'zone']) + "?" + "&".join(),
...
def stop(instance=None, project=None, zone=None, discardLocalSsd=None, requestId=None):
...
def suspend(instance=None, project=None, zone=None, discardLocalSsd=None, requestId=None):
    url = baseUrl + "{project}/zones/{zone}/instances/{instance}/suspend"
    method = "POST"
    return Request(
        method, 
        url.format(['instance', 'project', 'zone']) + "?" + "&".join(),
